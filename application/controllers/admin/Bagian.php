...
class Bagian extends CI_Controller
{
	...
	public function index()
	{
		...
		$data = array(
			'title'		=> 'Bagian dan Unit Kerja (' . $total->total . ' data)',
			'bagian'	=> $bagian,
	...
	public function tambah()
	{
		...
		$validasi->set_rules(
			'nama_bagian',
			'Nama Bagian',
			'required|is_unique[bagian.nama_bagian]',
			array(
		...
		$validasi->set_rules(
			'kode_bagian',
			'Kode Bagian',
			'required|is_unique[bagian.kode_bagian]',
			array(
				'required'		=> '%s harus diisi',
	...
	public function edit($id_bagian)
	{
		...
		if ($validasi->run() === FALSE) {
			...
			$data = array(
				'title'		=> 'Edit Bagian: ' . $bagian->nama_bagian,
				'bagian'		=> $bagian,
